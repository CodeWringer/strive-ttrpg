...
In addition, the Capital **always** loses `3` Supplies and gains `1D10` People at the start of every session. 
...
| 4    | A chemical lab accident releases a noxious cloud of gas over the Capital. **Choose**: 1. Order the people to stay indoors. You lose `1D6` People and `1D10 + 5` Supplies, but gain `5` Unity. <br> 2. Order the people to continue their work, despite the danger. You Lose `2D10` People and `1D10` Unity. |
