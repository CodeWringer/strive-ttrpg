...
If the Defense fails, the full effect is applied. If it causes a [Spell-Backfire](#spell-backfire) on the defender, they suffer the attacker's spell at one greater [Intensity](#spell-intensity-si) level. 
